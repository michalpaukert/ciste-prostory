...
export const Menu: React.FC = (props) => (
    <div className="menu uk-width-1-2">
      ...
      <a className="menu-contact" href="">Kontakt</a>
      <a className="uk-button uk-button-default" uk-toggle="target: #offcanvas-flip"><img src="img/menu.png"></a>

      <div id="offcanvas-flip" uk-offcanvas="flip: true; overlay: true" className="uk-offcanvas">
        <div className="uk-offcanvas-bar">
          <img src="img/logo_prostory.png"><br>
